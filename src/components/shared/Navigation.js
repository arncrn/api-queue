  ...
  <Navbar>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="ml-auto">
        { props.loggedIn && <Nav.Link className="mr-1" as={Link} to="/app">App</Nav.Link>}
        ...
        {props.loggedIn && <Nav.Link className="mr-1" as={Link} to="/" onClick={props.logout}>Log Out</Nav.Link>}
      </Nav>
    </Navbar.Collapse>
</Navbar>
);
